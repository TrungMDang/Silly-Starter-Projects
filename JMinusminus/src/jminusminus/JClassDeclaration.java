...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    public ArrayList<JMember> getClassBlock() {
    	ArrayList<JMember> newCB = new ArrayList<JMember>();
    	for (int i = 0; i < this.classBlock.size(); i++) {
    		newCB.add(this.classBlock.get(i));
    	}
    	return newCB;
    }
    /**
    ...
    public JAST analyze(Context context) {
    			...
    			if (mods.contains("public")) {
    				context.setNumberOfPublicType(context.getNumberOfPublicType() + 1);
    			}
