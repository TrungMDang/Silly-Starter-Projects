...
class JMethodDeclaration
     ...
     *                method body.
     */
    /**OLD Method signature that causes parameters differ in length exception
    ...
    public ArrayList<TypeName> getExceptions() {
    	ArrayList<TypeName> newArray = new ArrayList<TypeName>();
    	for (int i = 0; i < this.exceptions.size(); i++) {
    		newArray.add(this.exceptions.get(i));
    	}
    	return newArray;
    }
