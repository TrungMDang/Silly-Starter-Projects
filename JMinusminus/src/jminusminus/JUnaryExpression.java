...
class JPostIncrementOp extends JUnaryExpression {
    ...
    /**
     * In generating code for a post-increment operation.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JNotOp extends JUnaryExpression {
    ...
    /**
     * Construct an AST node for a ! given its line number, and the
     * operand.
     * 
     * @param line
     *            line in which the expression occurs in the source file.
...
class JUplusOp extends JUnaryExpression {
    ...
    public JUplusOp(int line, JExpression arg) {
        super(line, "+", arg);
    }
...
//        type = Type.INT;
    ...
    /**
     * Generating code for the unary plus operation.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
