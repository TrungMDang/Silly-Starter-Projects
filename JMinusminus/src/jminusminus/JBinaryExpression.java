...
class JModOp extends JBinaryExpression {
    ...
    /**
     * Generating code for the % operation.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JURShiftOp extends JBinaryExpression {
	
	public JURShiftOp(int line, JExpression lhs, JExpression rhs) {
		super(line, ">>>", lhs, rhs);
	}
	 public JExpression analyze(Context context) {
//       lhs = (JExpression) lhs.analyze(context);
...
class JBEOrOp extends JBinaryExpression {
	
	public JBEOrOp(int line, JExpression lhs, JExpression rhs) {
		super(line, "^", lhs, rhs);
	}
	 public JExpression analyze(Context context) {
//       lhs = (JExpression) lhs.analyze(context);
