...
class JMultiAssignOp extends JAssignment {
    ...
    public JMultiAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "*=", lhs, rhs);
    }
...
class JBandAssignOp extends JAssignment {
    ...
    public JBandAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "&=", lhs, rhs);
    }
...
class JBeorAssignOp extends JAssignment {
    ...
    public JBeorAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "^=", lhs, rhs);
    }
...
class JBiorAssignOp extends JAssignment {
    ...
    public JBiorAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "|=", lhs, rhs);
    }
...
class JUrshiftAssignOp extends JAssignment {
    ...
    public JUrshiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>=", lhs, rhs);
    }
