    ...
    public JExpression analyze(Context context) {
        ...
        if (iDefn == null) {
            ...
            if (field == null) {
                ...
                JExpression newT = new JVariable(line(), name);
                return newT.analyze(context);
                ...
                JExpression newTree = new JFieldSelection(line(), field.isStatic()
                        ...
                        context.methodContext().isStatic()) ? new JVariable(line(), definingType.toString()) : 
                        										new JThis(line), name);
        ...
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                if (type == Type.INT || type == Type.BOOLEAN
                	...
                	switch (offset) {
                    case 0:
                        output.addNoArgInstruction(FSTORE_0);
                        break;
                    case 1:
                        output.addNoArgInstruction(FSTORE_1);
                        break;
                    case 2:
                        output.addNoArgInstruction(FSTORE_2);
                        break;
                    case 3:
                        output.addNoArgInstruction(FSTORE_3);
                        break;
                    default:
                        output.addOneArgInstruction(FSTORE, offset);
                        break;
                    }
                }
            }
